...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "games" ADD "total_bigger_coefficient" DOUBLE PRECISION;
        ...
        ALTER TABLE "games" ADD "total_less_coefficient" DOUBLE PRECISION;"""
...
async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "games" DROP COLUMN "total_bigger_coefficient";
        ...
        ALTER TABLE "games" DROP COLUMN "total_less_coefficient";"""
